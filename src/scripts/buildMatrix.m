...
The data in the folder '../src/scripts/data/' was put into this file 
structure using mD_2.py (this script can be found here: 
'../src/scripts/data/other/'
...
for i = 1:(width(train_file))
    data_train = ['../src/scripts/data/' + train_file(i) ];
    data_test = ['../src/scripts/data/' + test_file(i) ];
